"""
Mean-reversion version of recent_1m_test.py - reruns the trailing
1-month window using mean_reversion.py's DEFAULT_PARAMS, for a direct
comparison against the momentum strategy's result on the same window.

Same caveat as recent_1m_test.py: ~21 trading days is a small sample,
treat this as a sanity check, not a robustness result on its own.
"""
