"""
Reruns the strategy over the trailing 2-year window (today minus ~2
years through today) using whatever DEFAULT_PARAMS currently live in
vector_validate.py. This is the same style of window we originally
validated the strategy on before regime_test.py was added to check
robustness across multiple historical market conditions - use this to
see how parameter changes affect that original reference window.
"""
